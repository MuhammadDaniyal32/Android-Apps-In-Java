...
import com.example.activity_demos.dummy.DummyContent;
...
public class demoListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.demo_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final demoListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(demoDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(demoDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(demoListActivity parent,

...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerGenre = (EditText) findViewById(R.id.spinnerGenres);
        ...
        listViewArtists.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //creating an intent
                Intent intent = new Intent(getApplicationContext(), activity_artist.class);
    ...
    private void showUpdateDeleteDialog(final String artistId, String artistName) {
        ...
        final View dialogView = inflater.inflate(R.layout.activity_update_dialogue, null);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String genre = spinnerGenre.getText().toString();
